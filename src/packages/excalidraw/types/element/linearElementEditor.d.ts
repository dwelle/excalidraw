...
export declare class LinearElementEditor {
    ...
    static handlePointerDown(event: React.PointerEvent<HTMLCanvasElement>, appState: AppState, setState: React.Component<any, AppState>["setState"], history: SceneHistory, scenePointer: {
        x: number;
        y: number;
    }): {
        didAddPoint: boolean;
